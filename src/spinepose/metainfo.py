metainfo = dict(
    ...
    keypoint_info={
        ...
        1: dict(
            name="left_eye", id=1, color=[204, 51, 51], type="upper", swap="right_eye"
        ),
        2: dict(
            name="right_eye", id=2, color=[204, 51, 51], type="upper", swap="left_eye"
        ),
        3: dict(
            name="left_ear", id=3, color=[204, 51, 51], type="upper", swap="right_ear"
        ),
        4: dict(
            name="right_ear", id=4, color=[204, 51, 51], type="upper", swap="left_ear"
        ),
        5: dict(
            name="left_shoulder",
            id=5,
        ...
        11: dict(
            name="left_hip", id=11, color=[204, 51, 51], type="lower", swap="right_hip"
        ),
        12: dict(
            name="right_hip", id=12, color=[204, 51, 51], type="lower", swap="left_hip"
        ),
        13: dict(
            name="left_knee",
            id=13,
        ...
        31: dict(
            name="left_latissimus",
            id=31,
            color=[204, 51, 51],
            type="upper",
            swap="right_latissimus",
        ),
        32: dict(
            name="right_latissimus",
            id=32,
            color=[204, 51, 51],
            type="upper",
            swap="left_latissimus",
        ),
        33: dict(
            name="left_clavicle",
            id=33,
